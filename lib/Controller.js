...
class Controller {
  ...
  _compareData(oldData, newData) {
    var compare = {};
    Object.entries(oldData).forEach((_ref3, index) => {
      var [keyoldval, oldval] = _ref3;
  ...
  _checkPopulateSended(req) {
    Object.entries(this.model.def.attributes).forEach((_ref4, index) => {
...
function _loadControllers() {
  _loadControllers = _asyncToGenerator(function* () {
    ...
    for (var i = 0; i < controllerFiles.length; i++) {
      ...
      Object.entries(obj).forEach((_ref5, index) => {
        var [name, constructorFn] = _ref5;
