...
class Controller {
  ...
  createEmpty(req) {
    ...
    return _asyncToGenerator(function* () {
      ...
      row[_this8._getPrimary(_this8.model)] = "";
      return row;
    })();
  }
  ...
  _create(req) {
    ...
    return _asyncToGenerator(function* () {
      // console.log("req", req);
      //Services.simpleSanitizeReq(req);
      var primary = _this10._getPrimary(_this10.model); // console.log("req.body", req.body);


      _this10._checkPopulateSended(req);

      var newrow = yield _this10.model.create(req.body).exec(true);
      if (!newrow) return null; // console.log("req.body2 :", req.body, this.model, newrow);
  ...
  _destroy(req) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var where = "",
          whereData = [],
          primary = _this12._getPrimary(_this12.model),
          oldrow,
  ...
  _log(req, modelEvent, oldrow, newrow) {
    ...
    return _asyncToGenerator(function* () {
      var primary = _this13._getPrimary(_this13.model),
          id = req.params.id || req.params[primary];
