...
module.exports = class DbTableExec {
  ...
  _preTreatment() {
    for (var [fieldName, field] of Object.entries(this.def.attributes)) {
      if (!fieldName || this.data[fieldName] === undefined) continue; // if (this.data[fieldName]===null)
  ...
  _beforeQuery() {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (fn) yield fn(_this.data);else if (fn2) yield fn(); // console.log("this.data", this.data);
    })();
  }
  ...
  exec() {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (_this2.def.debug || _this2.logQuery) console.warn("query", chalk.yellowBright(query), chalk.cyan(_this2.whereData));
      var rows;
